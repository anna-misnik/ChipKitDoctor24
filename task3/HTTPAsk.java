...
public class HTTPAsk {
    public static void main(String[] args) throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(hostPort); //creates new welcome socket; listens and binds

        while (true) { //server works in infinite loop; always ready for new connections
            Socket connectionSocket = welcomeSocket.accept(); //new socket for the client, connection accepted
